...
const BALL_DATA:BingoBallData = preload("res://data/balls/player/bingo_ball_throwing_axe.tres")
...
func test_placement_rules() -> void:
	assert_eq(BALL_DATA.placement_rule, BingoBallData.PlacementRule.PRIORITIZE_EDGE)
...
func test_has_power_up() -> void:
	...
	assert_false(ball_data.highlight_description_keys["edge"])
	...
	assert_true(ball_data.highlight_description_keys["edge"])

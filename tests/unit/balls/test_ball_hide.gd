...
const BALL_DATA:BingoBallData = preload("res://data/balls/enemy/bingo_ball_hide.tres")
...
func test_add_disable_to_adjacent_spaces() -> void:
	...
	var disabled_space_indexes := [2, 12, 6, 8]

class_name SpaceEffectStrength
extends SpaceEffect
		
func _has_bingo_event(bingo_space_data:BingoSpaceData) -> bool:
	return bingo_space_data.ball_data.team == BingoBallData.Team.PLAYER && bingo_space_data.ball_data.type == BingoBallData.Type.ATTACK

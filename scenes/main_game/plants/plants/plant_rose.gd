...
func _trigger_ability(ability_type:AbilityType, main_game:MainGame) -> void:
	...
	await main_game.tool_manager.add_temp_tools_to_draw_pile([tool_data], Util.get_node_ui_position(main_game.gui_main_game.gui_tool_card_container, self), true, true)

...
func discard_cards(indices:Array, gui_plant_seed_animation_container:GUIPlantSeedAnimationContainer) -> void:
	await gui_plant_seed_animation_container.animate_discard(indices)

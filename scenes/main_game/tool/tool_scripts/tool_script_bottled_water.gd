...
func apply_tool(_combat_main:CombatMain, plants:Array, field_index:int, tool_data:ToolData, _secondary_card_datas:Array) -> void:
	...
	_card_spawn_position = Util.get_node_canvas_position(plant) - GUICardFace.SIZE / 2

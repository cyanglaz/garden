...
func apply_weather_actions(fields:Array[Field], today_weather_icon:GUIWeather, combat_main:CombatMain) -> void:
	await _apply_weather_action_to_next_field(fields, 0, today_weather_icon, combat_main)
...
func _apply_weather_action_to_next_field(fields:Array[Field], field_index:int, today_weather_icon:GUIWeather, combat_main:CombatMain) -> void:
	...
	if !_should_weather_be_applied(today_weather, field):
		await _apply_weather_action_to_next_field(fields, field_index + 1, today_weather_icon, combat_main)
	else:

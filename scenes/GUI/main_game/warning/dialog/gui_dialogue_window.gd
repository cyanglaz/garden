...
const DIALOGUE_ITEM_SCENE := preload("res://scenes/GUI/main_game/warning/dialog/gui_dialogue_item.tscn")
...
func clear_all_dialogue_items() -> void:
	Util.remove_all_children(v_box_container)

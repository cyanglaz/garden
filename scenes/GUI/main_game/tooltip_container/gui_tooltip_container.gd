...
const GUI_COMBAT_TOOLTIP_SCENE := preload("res://scenes/GUI/tooltips/gui_combat_tooltip.tscn")
...
func _create_tooltip(tooltip_type:TooltipRequest.TooltipType) -> GUITooltip:
	match tooltip_type:
		...
		TooltipRequest.TooltipType.COMBAT:
			return GUI_COMBAT_TOOLTIP_SCENE.instantiate()

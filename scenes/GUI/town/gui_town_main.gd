...
@onready var free_hp_button: GUIEventSelectionButton = %FreeRatingButton
@onready var paid_hp_button: GUIEventSelectionButton = %PaidRatingButton
...
func _on_paid_hp_button_pressed() -> void:
	Events.request_hp_update.emit(RATING_GAIN_PAID)

...
func _ready():
	...
	_new_game_button.action_evoked.connect(_on_new_game_button_action_evoked)
	_options_button.action_evoked.connect(_on_options_button_action_evoked)
	_exit_button.action_evoked.connect(_on_exit_button_action_evoked)
...
func _on_options_button_action_evoked() -> void:
	_gui_settings_main.animate_show()

func _on_credits_button_action_evoked() -> void:
	_gui_credits_panel.animate_show()

func _on_exit_button_action_evoked() -> void:
	get_tree().quit()

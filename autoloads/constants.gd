...
const COLOR_BLUE_5 := Color("0069aa")
const COLOR_BLUE_6 := Color("00396d")
...
const COLOR_BROWN_1 := Color("bf6f4a")
...
const RESOURCE_INSUFFICIENT_COLOR := Constants.COLOR_GRAY4
const COST_DEFAULT_COLOR := Constants.COLOR_PURPLE0
const COST_UPDATED_COLOR := Constants.COLOR_BLUE_1
const COST_INCREASED_COLOR := Constants.COLOR_ORANGE1
const CARD_DISABLED_COLOR := Constants.COLOR_RED1

const COMBAT_THEME_COLOR_COMMON := Constants.COLOR_GREEN2
const COMBAT_THEME_COLOR_ELITE := Constants.COLOR_BLUE_3
const COMBAT_THEME_COLOR_BOSS := Constants.COLOR_RED
...
const HP_INCREASE_COLOR := Constants.COLOR_GREEN1
const HP_DECREASE_COLOR := Constants.COLOR_RED3
const ENERGY_INCREASE_COLOR := Constants.COLOR_PURPLE1
const ENERGY_DECREASE_COLOR := Constants.COLOR_PURPLE3
const MOVEMENT_INCREASE_COLOR := Constants.COLOR_GREEN1
const MOVEMENT_DECREASE_COLOR := Constants.COLOR_GREEN3


const GLOBAL_UPGRADE_PAUSE_TIME := 0.2

const ENCHANT_TEXT_COLOR := Constants.COLOR_PURPLE0
const ENCHANT_TEXT_OUTLINE_COLOR := Constants.COLOR_RED_PURPLE4

const WEATHER_QUEUE_CATEGORY := "weather"

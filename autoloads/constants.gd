...
const CONTRACT_THEME_COLOR_COMMON := Constants.COLOR_GREEN2
const CONTRACT_THEME_COLOR_ELITE := Constants.COLOR_BLUE_3
const CONTRACT_THEME_COLOR_BOSS := Constants.COLOR_RED
